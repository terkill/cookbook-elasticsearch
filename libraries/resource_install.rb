class Chef
  class Resource
    ...
    class ElasticsearchInstall < Chef::Resource::LWRPBase
      ...
      attribute(:source_url, kind_of: String, default: 'https://download.elasticsearch.org/elasticsearch/elasticsearch/elasticsearch-%s.tar.gz')
