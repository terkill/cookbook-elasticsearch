class Chef
  class Resource
    ...
    class ElasticsearchUser < Chef::Resource::LWRPBase
      ...
      attribute(:homedir_name, kind_of: String, name_attribute: true) # default to username
      attribute(:homedir_parent, kind_of: String, default: '/usr/local') # windows requires override
      attribute(:homedir, kind_of: String, default: nil) # combination of previous two

      attribute(:groupname, kind_of: String, name_attribute: true) # default to username
